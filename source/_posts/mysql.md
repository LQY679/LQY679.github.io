...
![image-20230218163000095](mysql/image-20230218163000095.png)
...
##### 第一范式(1NF)
*原子性: 保证每一列不可再分*
![image-20230218163107901](mysql/image-20230218163107901.png)

##### 第二范式(2NF)
*完全依赖:非主属性完全依赖于主键*
![image-20230218163146007](mysql/image-20230218163146007.png)

##### 第三范式(3NF)

*消除传递依赖:非主属性必须直接依赖于主键*
![image-20230218163209397](mysql/image-20230218163209397.png)
...
### JDBC(重点)
***
![image-20230218163227282](mysql/image-20230218163227282.png)
#### JDBC介绍
