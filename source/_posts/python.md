...
![image-20230101123625804](python/image-20230101123625804.png)
...
![image-20230101190310790](python/image-20230101190310790-16725709925971.png)
...
![image-20230101191235876](python/image-20230101191235876.png)
...
![image-20230112121927577](python/image-20230112121927577.png)
...
![image-20230110103512311](python/image-20230110103512311.png)
...
![image-20230110125739732](python/image-20230110125739732.png)
...
![image-20230124102103677](python/image-20230124102103677.png)

参数:

![image-20230124102132541](python/image-20230124102132541.png)
...
![image-20230124103304516](python/image-20230124103304516.png)

我们点击`loadPostList()`进入分析:

![image-20230124103541628](python/image-20230124103541628.png)
...
![image-20230124123720967](python/image-20230124123720967.png)
...
![image-20230124184225374](python/image-20230124184225374.png)
...
![image-20230125154551816](python/image-20230125154551816.png)
...
![image-20230126220440586](python/image-20230126220440586.png)	
...
![image-20230126230337615](python/image-20230126230337615.png)
...
![image-20230126215949456](python/image-20230126215949456.png)
...
![image-20230201212638168](python/image-20230201212638168.png)
...
![image-20230202082526264](python/image-20230202082526264.png)

随后填写配置信息, 包括操作系统版本信息,App包名,和活动名等配置:

![image-20230202082804341](python/image-20230202082804341.png)

随后便可以看到对应元素的特征:

![image-20230202084331069](python/image-20230202084331069.png)
...
![image-20230202085847079](python/image-20230202085847079.png)

**UI界面介绍:**上方区域 : 4个按钮从左至右功能分别是：打开已经保存的布局，**获取详细布局**，获取简洁布局，保存布局。

![image-20230202090022390](python/image-20230202090022390.png)
...
![image-20230205102618956](python/image-20230205102618956.png)
,随后在word中进行一些操作,随便输入一些样式, 随后 停止录制宏:

![image-20230205103056010](python/image-20230205103056010.png)

然后**查看** 我们录制的宏, **选择编辑**

![image-20230205103322111](python/image-20230205103322111.png)

随后便可以看到对应操作的vbs脚本:

![image-20230205103401705](python/image-20230205103401705.png)
...
![image-20230206104214156](python/image-20230206104214156.png)
...
![image-20230206114624491](python/image-20230206114624491.png)
...
![image-20230207222136695](python/image-20230207222136695.png)
...
![image-20230207235702626](python/image-20230207235702626.png)
...
![image-20230209103237085](python/image-20230209103237085.png)
...
![image-20230210171157158](python/image-20230210171157158-16760203186051.png)
...
![image-20230210172603986](python/image-20230210172603986.png)
...
![image-20230210213423747](python/image-20230210213423747.png)
...
![image-20230211160013124](python/image-20230211160013124.png)
...
![image-20230211161235313](python/image-20230211161235313.png)
...
复合索引指的是多层列索引,对应excel表格结构如下图所示: 
 ...
 ![image-20230211224116968](python/image-20230211224116968.png)
...
![image-20230209173734976](python/image-20230209173734976.png)

`names`: 列表类型,自定义表头, 注意, 如果自定义表头, 需要指定`header=None` , 否则数据会错误

![image-20230209180842860](python/image-20230209180842860.png)

`index_col`: 指定index(行标签)使用哪些列,即行索引

![image-20230209232130622](python/image-20230209232130622.png)
...
![image-20230209174326871](python/image-20230209174326871.png)
...
![image-20230209230640362](python/image-20230209230640362.png)
...
![image-20230209231213793](python/image-20230209231213793.png)

###### 千位分隔符

![image-20230209232743589](python/image-20230209232743589.png)

###### 浮点数取整处理

![image-20230209232851809](python/image-20230209232851809.png)
...
![image-20230209232609505](python/image-20230209232609505.png)
...
![image-20230213215644347](python/image-20230213215644347.png)
